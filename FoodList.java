...
public class FoodList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final Cursor cursor = Login.sqLiteHelper.getData("SELECT * FROM FOOOD");
        list.clear();
        while (cursor.moveToNext()) {
            ...
            list.add(new Food(name, price, image,email, id));
        }
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = Login.sqLiteHelper.getData("SELECT id FROM FOOOD");
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    FoodMain.sqLiteHelper.updateData(
    ...
    private void showDialogDelete(final int idFood){
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    Login.sqLiteHelper.deleteData(idFood);
    ...
    private void updateFoodList(){
        // get all data from sqlite
        Cursor cursor = Login.sqLiteHelper.getData("SELECT * FROM FOOOD");
        list.clear();
        while (cursor.moveToNext()) {
            int id = cursor.getInt(0);
            String name = cursor.getString(1);
