...
public class HotelList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(HotelList.this,orderhotel.class);
                ...
                String editemail = ((TextView)view.findViewById(R.id.editemail)).getText().toString();
        ...
        Cursor cursor = Login.sqLiteHelper.getData("SELECT * FROM HOTEL");
        list.clear();
        while (cursor.moveToNext()) {
            ...
            list.add(new Hotel(name, price, image, id));
        }
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = HotelMain.sqLiteHelper.getData("SELECT id FROM HOTEL");
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    HotelMain.sqLiteHelper.updateData1(
                            edtName.getText().toString().trim(),
                            edtPrice.getText().toString().trim(),
                            HotelMain.imageViewToByte(imageViewFood),
                            position
                    );
                    dialog.dismiss();
    ...
    private void showDialogDelete(final int idHotel){
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    HotelMain.sqLiteHelper.deleteData1(idHotel);
    ...
    private void updateHotelList(){
        // get all data from sqlite
        Cursor cursor = HotelMain.sqLiteHelper.getData("SELECT * FROM HOTEL");
        list.clear();
        while (cursor.moveToNext()) {
            int id = cursor.getInt(0);
            String name = cursor.getString(1);
