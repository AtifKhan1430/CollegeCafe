...
public class orderstationary extends AppCompatActivity {
    TextView name,email;
    TextView price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ib_addnew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Stationary.CartQuantity = Food.CartQuantity + 1;
                edTextQuantity.setText(Stationary.CartQuantity + "");
            }
        });
        ib_remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Stationary.CartQuantity = Stationary.CartQuantity - 1;
                edTextQuantity.setText(Stationary.CartQuantity + "");
            }
        });
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(orderstationary.this,payment.class);
